...
def checkException(word): # Checa se a palavra corresponde a uma exceção (artigo, preposição ou conjunção)
	exceptionsPort = ['o', 'os', 'a', 'as', 'um', 'uns', 'uma', 'umas',
			          'ao', 'aos', 'à', 'às', 'do', 'dos', 'da', 'das',
			          'dum', 'duns', 'duma', 'dumas', 'no', 'nos', 'na',
			          'nas', 'num', 'nuns', 'numa', 'numas', 'pelo', 'pelos', 
			          'pela', 'pelas', 'ante', 'após', 'até', 'com', 'de', 
			          'em', 'para', 'por', 'sem', 'sob', 'trás', 'e', 'nem', 
			          'mas', 'ou', 'já', 'que', 'pois']
	
	exceptionsEng = ['and', 'but', 'or', 'so', 'the', 'a', 'an', 'of', 'in', 
	                 'on', 'to', 'for', 'at', 'as', 'with']

	exceptionsEsp = ['a', 'de', 'en', 'por', 'con', 'para', 'sin', 'y', 'ni',
					 'que', 'así', 'no', 'o', 'ya', 'el', 'él', 'la', 'lo', 
...
def titleCase(text):
	...
	final_words += [word if checkException(word) == True else word.capitalize() for word in lowercase_words[1:]]
